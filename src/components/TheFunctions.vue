...
<template>
  <FunctionItem>
    <template #heading>
      <a href="https://vueuse.org/core/usetitle/#usetitle" target="_blank">
        UseTitle
      </a>
    </template>
  ...
  <FunctionItem>
    <template #heading>
      <a
        href="https://vueuse.org/core/usepageleave/#usepageleave"
        target="_blank"
      >
        usePageLeave
      </a>
  ...
  <FunctionItem>
    <template #heading>
      <a href="https://vueuse.org/shared/useintervalfn" target="_blank">
        useIntervalFn
      </a>
    </template>
